                        ...
                        {foreach $dnsrecords as $dnsrecord}
                            <tr>
                                <td><input type="hidden" name="dnsrecid[]" value="{$dnsrecord.recid}" /><input type="text"
                                        name="dnsrecordhost[]" value="{$dnsrecord.hostname}" size="10" class="form-control" />
                                </td>
                                <td>
                                    <select name="dnsrecordtype[]" class="form-control">
                                        <option value="A" {if $dnsrecord.type eq "A"} selected="selected" {/if}>
                                            {lang key="domainDns.a"}</option>
                                ...
                                <td>
                                    {if $dnsrecord.type eq "MX"}<input type="text" name="dnsrecordpriority[]"
                                        ...
                                        name="dnsrecordpriority[]" value="N/A" />{lang key='domainregnotavailable'}{/if}
                                </td>
                            </tr>
                        {/foreach}
                        <tr>
