...
<div class="card">
    <div class="card-body">
        ...
        <form method="post" action="{$smarty.server.PHP_SELF}?action=domaincontacts" id="frmDomainContactModification">
            ...
            <!-- CNIC/ISPAPI: additional fields HTML injection: START -->
            {if isset($additionalfields)}
                <hr />
                <div class="p-4">
                {foreach from=$additionalfields key=$fieldLabel item=$inputHTML}
                    <div class="form-group">
            ...
            {/if}
            <!-- CNIC/ISPAPI: additional fields HTML injection: END -->
