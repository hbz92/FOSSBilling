...
{elseif !empty($conflictingApps.webapps)}
    <div class="alert alert-warning" role="alert"><b>CAUTION</b>: By connecting <b>{$allApps[$webapp].alt}</b> the following
        already connected Web Apps will be disconnected: <b>
...
src="{$WEB_ROOT}/resources/cnic/assets/js/ispapi/webapps.js?ts={constant("CNIC_VERSION")}"></script>